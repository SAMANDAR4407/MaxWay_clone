...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    // } else {
    //   Navigator.push(context, CupertinoPageRoute(builder: (context) => const PhonePage(page: 'profil'),));
    // }
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        if(!hasLogged){
          return const PhonePage(page: 'profil');
        }
        else {
          return Scaffold(
            appBar: AppBar(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: const Row(
                              ...
                              children: [
                                Icon(CupertinoIcons.placemark, size: 25,),
                                SizedBox(width: 10,),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: const Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(CupertinoIcons.map_pin_ellipse, size: 25,),
                                SizedBox(width: 10,),
                                Expanded(
                                    child: Text(
                                      'Filiallar',
